...
| store  | board, serialization | Takes a board and returns an ID that can be used to retrieve the board again. Currently does not actually store boards, but encodes the board in the returned id. |
